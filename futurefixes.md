...
| The detailed execution trace is process-local and is lost with the session. | → | Persist redacted trace events alongside replay-safe turn results, with retention limits and access control. |
