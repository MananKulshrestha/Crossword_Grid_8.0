...
- Qwen3.6 27B is configured as an alias, not a hard-coded business assumption. The provider, tokenizer, structured-output support, context window, quantization, and license must be verified before changing the alias in a release tuple.
