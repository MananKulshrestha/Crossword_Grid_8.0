    ...
    def _finish(
        ...
        *,
        ...
        event = RecoveryEvent(
            ...
            baseline_eligible_count=request.baseline_run.eligible_count,
            baseline_popular_result_count=request.baseline_run.popular_result_count,
            selected_eligible_count=selected_run.eligible_count if selected_run else None,
            selected_popular_result_count=selected_run.popular_result_count if selected_run else None,
